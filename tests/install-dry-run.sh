...
assert_contains "$menu_script" "16) BBR / Telegram 状态"
assert_contains "$menu_script" "18) 一键更新本项目"
assert_contains "$menu_script" "19) 卸载 / 清理本项目"
...
assert_contains "$menu_script" "4) 编辑现有转发规则"
assert_contains "$menu_script" "8) 查看 Stats 流量统计"
